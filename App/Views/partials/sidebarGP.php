            ...
            <ul id="accordion-menu">
                ...
                <li>
                    <a href="<?php echo url('/dashboard'); ?>" class="dropdown-toggle no-arrow sidebar-link" id="dashboard-link">
                        <span class="micon dw dw-analytics-11"></span><span class="mtext">Dashbard</span>
                    </a>
                </li>	
                <li class="dropdown">
                    <a href="javascript:;" class="dropdown-toggle sidebar-link" id="usuarios-link">
                        <span class="micon dw dw-user-13"></span><span class="mtext">Cadastros</span>
                    </a>
                    <ul class="submenu">
                        <li><a href="<?php echo url('/users'); ?>" class="sidebar-link" id="users-link">Usuário</a></li>
                        <li><a href="<?php echo url('/users-profiles'); ?>" class="sidebar-link" id="users-profiles-link">Perfil</a></li>
                        <li><a href="<?php echo url('/users-systems'); ?>" class="sidebar-link" id="users-systems-link">Sistema</a></li>
                    </ul>
                </li>
            </ul>
        </div>
